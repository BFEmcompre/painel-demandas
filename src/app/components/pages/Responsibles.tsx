...
const { data: tasks, error: tasksError } = await supabase
  ...
  return (
    <div className="space-y-6 min-h-screen px-1 pb-10 text-gray-900 dark:text-white">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="rounded-2xl border border-[#1c3a5e] bg-[#0d1830] text-white hover:bg-[#12233d]"
        >
          Atualizar lista
        </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {responsibles.map((resp) => {
            ...
            return (
              ...
              <Card
                key={resp.id}
                className="rounded-[28px] border border-gray-200 dark:border-[#173220] bg-white dark:bg-[#08110c]/96 p-6 shadow-[0_24px_70px_-46px_rgba(0,0,0,.08)] dark:shadow-[0_24px_70px_-46px_rgba(0,0,0,.95)] transition-all hover:border-[#38bdf8]/40"
              >
