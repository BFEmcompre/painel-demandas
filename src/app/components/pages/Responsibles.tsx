  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold text-gray-900 dark:text-white">Responsáveis</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">Acompanhe os usuários cadastrados no sistema</p>
        </div>
