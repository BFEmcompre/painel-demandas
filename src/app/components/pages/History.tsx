  ...
  return (
    <div className="space-y-6 min-h-screen bg-white dark:bg-[#0B0B0B] text-gray-900 dark:text-white p-1">
      ...
      <Card className="p-6 bg-white dark:bg-[#121212] border border-gray-200 dark:border-[#1F1F1F]">
        ...
        <div className="flow-history-table border border-gray-200 dark:border-[#1F1F1F] rounded-lg overflow-hidden">
          
          <Table>
            <TableHeader>
              <TableRow className="flow-history-head bg-gray-50 dark:bg-[#181818] border-b border-gray-200 dark:border-[#1F1F1F]">
